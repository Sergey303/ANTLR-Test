...
public partial class sparql2PacParser : Parser {
	public const int
	...
	public override string GrammarFileName { get { return "sparql2Pac.g4"; } }
	...
	public sparql2PacParser(ITokenStream input)
		: base(input)
	{
	...
	public partial class QueryContext : ParserRuleContext {
		...
		public override void EnterRule(IParseTreeListener listener) {
			Isparql2PacListener typedListener = listener as Isparql2PacListener;
		...
		public override TResult Accept<TResult>(IParseTreeVisitor<TResult> visitor) {
			Isparql2PacVisitor<TResult> typedVisitor = visitor as Isparql2PacVisitor<TResult>;
	...
	public partial class BasedeclContext : ParserRuleContext {
		public ITerminalNode IRI_REF() { return GetToken(sparql2PacParser.IRI_REF, 0); }
	...
	public partial class PrefixDeclContext : ParserRuleContext {
		...
		public ITerminalNode IRI_REF() { return GetToken(sparql2PacParser.IRI_REF, 0); }
		public ITerminalNode PNAME_NS() { return GetToken(sparql2PacParser.PNAME_NS, 0); }
	...
	public PrefixDeclContext prefixDecl() {
		...
		try {
			...
			{
			State = 165; Match(16);
			State = 166; _localctx._PNAME_NS = Match(PNAME_NS);
			State = 167; _localctx._IRI_REF = Match(IRI_REF);
		...
		try {
			...
			case VAR2:
				...
				do {
					{
					{
					State = 177; _localctx._varLiteral = varLiteral();
			...
			State = 194; whereClause();
			State = 195; solutionModifier();
			  q.CreateSelectRun(); 
			}
		}
		catch (RecognitionException re) {
	...
	public ConstructQueryContext constructQuery() {
		...
		try {
			...
			State = 206; whereClause();
			State = 207; solutionModifier();
		...
		try {
			...
			case VAR2:
				...
				do {
					...
					case VAR2:
						{
						State = 211; _localctx._varLiteral = varLiteral();
						q.variables.Add((_localctx._varLiteral!=null?_input.GetText(_localctx._varLiteral.start,_localctx._varLiteral.stop):null));
						}
						break;
					case PREFIXED_NAME:
					case IRI_REF:
						{
						State = 214; _localctx._iRIref = iRIref();
						 q.constants.Add(TripleInt.Code( (_localctx._iRIref!=null?_input.GetText(_localctx._iRIref.start,_localctx._iRIref.stop):null))); 
						}
						break;
					default:
						throw new NoViableAltException(this);
			...
			if (_la==5 || _la==49) {
				{
				State = 231; whereClause();
				}
			}

			State = 234; solutionModifier();
			q.CreateDescribeRun();
			}
		}
		catch (RecognitionException re) {
	...
	public DatasetClauseContext datasetClause() {
		...
		try {
			...
			case IRI_REF:
				{
				State = 248; defaultGraphClause();
				}
				break;
			case 73:
				{
				State = 249; namedGraphClause();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public WhereClauseContext whereClause() {
		...
		try {
			...
			State = 262; _localctx._groupGraphPattern = groupGraphPattern();
	...
	public SolutionModifierContext solutionModifier() {
		...
		try {
			...
			if (_la==15) {
				{
				State = 265; _localctx._orderClause = orderClause();
			...
			if (_la==41 || _la==68) {
				{
				State = 270; _localctx._limitOffsetClauses = limitOffsetClauses();
	...
	public LimitOffsetClausesContext limitOffsetClauses() {
		...
		try {
			...
			case 68:
				{
				State = 275; _localctx._limitClause = limitClause();
				 _localctx.value = _localctx._limitClause.value; 
				State = 280;
				_la = _input.La(1);
				if (_la==41) {
					{
					State = 277; _localctx._offsetClause = offsetClause();
			...
			case 41:
				{
				State = 282; _localctx._offsetClause = offsetClause();
				 _localctx.value = _localctx._offsetClause.value; 
				State = 287;
				_la = _input.La(1);
				if (_la==68) {
					{
					State = 284; _localctx._limitClause = limitClause();
	...
	public OrderClauseContext orderClause() {
		...
		try {
			...
			State = 291; Match(15);
			State = 292; Match(39);
			State = 293; _localctx.main = orderCondition();
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 2) | (1L << 3) | (1L << 9) | (1L << 12) | (1L << 17) | (1L << 18) | (1L << 20) | (1L << 22) | (1L << 23) | (1L << 24) | (1L << 25) | (1L << 27) | (1L << 28) | (1L << 29) | (1L << 31) | (1L << 33) | (1L << 34) | (1L << 42) | (1L << 44) | (1L << 45) | (1L << 46) | (1L << 47) | (1L << 48) | (1L << 50) | (1L << 51) | (1L << 52) | (1L << 61) | (1L << 62))) != 0) || ((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & ((1L << (66 - 66)) | (1L << (71 - 66)) | (1L << (PREFIXED_NAME - 66)) | (1L << (IRI_REF - 66)) | (1L << (VAR1 - 66)) | (1L << (VAR2 - 66)))) != 0)) {
				{
				{
				State = 295; _localctx.others = orderCondition();
	...
	public OrderConditionContext orderCondition() {
		...
		try {
			...
			case 42:
				...
				State = 309; _localctx._brackettedExpression = brackettedExpression();
			...
			case VAR2:
				...
				case IRI_REF:
					{
					State = 312; _localctx._constraint = constraint();
	...
	public partial class LimitClauseContext : ParserRuleContext {
		...
		public ITerminalNode INTEGER() { return GetToken(sparql2PacParser.INTEGER, 0); }
	...
	public LimitClauseContext limitClause() {
		...
		try {
			...
			{
			State = 322; Match(68);
			State = 323; _localctx._INTEGER = Match(INTEGER);
	...
	public OffsetClauseContext offsetClause() {
		...
		try {
			...
			{
			State = 326; Match(41);
			State = 327; _localctx._INTEGER = Match(INTEGER);
	...
	public GroupGraphPatternContext groupGraphPattern() {
		...
		try {
			...
			if (_la==4 || _la==44 || ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (PREFIXED_NAME - 75)) | (1L << (NumericLiteralPositive - 75)) | (1L << (NumericLiteralNegative - 75)) | (1L << (BooleanLiteral - 75)) | (1L << (String - 75)) | (1L << (BlankNode - 75)) | (1L << (IRI_REF - 75)) | (1L << (VAR1 - 75)) | (1L << (VAR2 - 75)) | (1L << (INTEGER - 75)) | (1L << (DECIMAL - 75)) | (1L << (DOUBLE - 75)) | (1L << (NIL - 75)))) != 0)) {
				{
				State = 331; _localctx.strt = triplesBlock();
			...
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 7) | (1L << 38) | (1L << 49) | (1L << 54))) != 0)) {
				...
				case 54:
					{
					State = 336; _localctx._graphPatternNotTriples = graphPatternNotTriples();
				...
				case 7:
					{
					State = 339; _localctx._filter = filter();
				...
				if (_la==4 || _la==44 || ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (PREFIXED_NAME - 75)) | (1L << (NumericLiteralPositive - 75)) | (1L << (NumericLiteralNegative - 75)) | (1L << (BooleanLiteral - 75)) | (1L << (String - 75)) | (1L << (BlankNode - 75)) | (1L << (IRI_REF - 75)) | (1L << (VAR1 - 75)) | (1L << (VAR2 - 75)) | (1L << (INTEGER - 75)) | (1L << (DECIMAL - 75)) | (1L << (DOUBLE - 75)) | (1L << (NIL - 75)))) != 0)) {
					{
					State = 347; _localctx.end = triplesBlock();
	...
	public TriplesBlockContext triplesBlock() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 359; _localctx._triplesSameSubject = triplesSameSubject();
			...
			if (_la==56) {
				...
				if (_la==4 || _la==44 || ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (PREFIXED_NAME - 75)) | (1L << (NumericLiteralPositive - 75)) | (1L << (NumericLiteralNegative - 75)) | (1L << (BooleanLiteral - 75)) | (1L << (String - 75)) | (1L << (BlankNode - 75)) | (1L << (IRI_REF - 75)) | (1L << (VAR1 - 75)) | (1L << (VAR2 - 75)) | (1L << (INTEGER - 75)) | (1L << (DECIMAL - 75)) | (1L << (DOUBLE - 75)) | (1L << (NIL - 75)))) != 0)) {
					{
					State = 362; _localctx.next = triplesBlock();
	...
	public GraphPatternNotTriplesContext graphPatternNotTriples() {
		...
		try {
			...
			case 38:
				EnterOuterAlt(_localctx, 1);
				{
				State = 369; _localctx._optionalGraphPattern = optionalGraphPattern();
			...
			case 49:
				EnterOuterAlt(_localctx, 2);
				{
				State = 372; _localctx._groupOrUnionGraphPattern = groupOrUnionGraphPattern();
			...
			case 54:
				...
				{
				State = 375; _localctx._graphGraphPattern = graphGraphPattern();
	...
	public OptionalGraphPatternContext optionalGraphPattern() {
		...
		try {
			...
			State = 382; _localctx._groupGraphPattern = groupGraphPattern();
	...
	public GraphGraphPatternContext graphGraphPattern() {
		...
		try {
			...
			{
			State = 385; Match(54);
			State = 386; varOrIRIref();
			State = 387; groupGraphPattern();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public GroupOrUnionGraphPatternContext groupOrUnionGraphPattern() {
		...
		try {
			...
			State = 390; _localctx.first = groupGraphPattern();
			...
			while (_la==72) {
				...
				State = 393; Match(72);
				State = 394; _localctx.second = groupGraphPattern();
	...
	public FilterContext filter() {
		...
		try {
			...
			State = 404; Match(7);
			 q.currentFilterParameter = Expression.Parameter(typeof (RPackInt));
			State = 406; _localctx._constraint = constraint();
	...
	public ConstraintContext constraint() {
		...
		try {
			...
			case 44:
				EnterOuterAlt(_localctx, 1);
				{
				State = 409; _localctx._brackettedExpression = brackettedExpression();
			...
			case 71:
				EnterOuterAlt(_localctx, 2);
				{
				State = 412; _localctx._builtInCall = builtInCall();
			...
			case IRI_REF:
				EnterOuterAlt(_localctx, 3);
				{
				State = 415; _localctx._functionCall = functionCall();
	...
	public FunctionCallContext functionCall() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 420; _localctx._iRIref = iRIref();
			State = 421; _localctx._argList = argList();
			_localctx.value = Query.Call(_localctx._iRIref.value, _localctx._argList.value);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public partial class ArgListContext : ParserRuleContext {
		...
		public ITerminalNode NIL() { return GetToken(sparql2PacParser.NIL, 0); }
	...
	public ArgListContext argList() {
		...
		try {
			...
			case 44:
				{
				State = 426; Match(44);
				State = 427; _localctx.main = expression();
				...
				while (_la==40) {
					...
					{
					State = 429; Match(40);
					State = 430; _localctx.second = expression();
	...
	public ConstructTriplesContext constructTriples() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 450; _localctx._triplesSameSubjectConstruct = triplesSameSubjectConstruct();
			...
			if (_la==56) {
				...
				if (_la==4 || _la==44 || ((((_la - 75)) & ~0x3f) == 0 && ((1L << (_la - 75)) & ((1L << (PREFIXED_NAME - 75)) | (1L << (NumericLiteralPositive - 75)) | (1L << (NumericLiteralNegative - 75)) | (1L << (BooleanLiteral - 75)) | (1L << (String - 75)) | (1L << (BlankNode - 75)) | (1L << (IRI_REF - 75)) | (1L << (VAR1 - 75)) | (1L << (VAR2 - 75)) | (1L << (INTEGER - 75)) | (1L << (DECIMAL - 75)) | (1L << (DOUBLE - 75)) | (1L << (NIL - 75)))) != 0)) {
					{
					State = 453; _localctx.next = constructTriples();
					}
				}
	...
	public TriplesSameSubjectConstructContext triplesSameSubjectConstruct() {
		...
		try {
			...
			case NIL:
				EnterOuterAlt(_localctx, 1);
				{
				State = 458; varOrTermSubConstruct();
				State = 459; _localctx._propertyListNotEmptyConstruct = propertyListNotEmptyConstruct();
			...
			case 44:
				EnterOuterAlt(_localctx, 2);
				{
				State = 462; triplesNode();
				State = 463; propertyList();
	...
	public VarOrTermSubConstructContext varOrTermSubConstruct() {
		...
		try {
			...
			case VAR2:
				EnterOuterAlt(_localctx, 1);
				{
				State = 468; _localctx._varLiteral = varLiteral();
			...
			case NIL:
				EnterOuterAlt(_localctx, 2);
				{
				State = 471; _localctx._graphTermConstuct = graphTermConstuct();
	...
	public PropertyListNotEmptyConstructContext propertyListNotEmptyConstruct() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 476; _localctx.main = verbObjectListConstruct();
			 _localctx.value = _localctx.main.value; 
			State = 486;
			_errHandler.Sync(this);
			_la = _input.La(1);
			while (_la==59) {
				...
				if (((((_la - 55)) & ~0x3f) == 0 && ((1L << (_la - 55)) & ((1L << (55 - 55)) | (1L << (PREFIXED_NAME - 55)) | (1L << (IRI_REF - 55)) | (1L << (VAR1 - 55)) | (1L << (VAR2 - 55)))) != 0)) {
					{
					State = 479; _localctx.seconds = verbObjectListConstruct();
	...
	public VerbObjectListConstructContext verbObjectListConstruct() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 489; verbConstruct();
			State = 490; _localctx._objectListConstruct = objectListConstruct();
	...
	public VerbConstructContext verbConstruct() {
		...
		try {
			...
			case VAR2:
				EnterOuterAlt(_localctx, 1);
				{
				State = 493; _localctx._varLiteral = varLiteral();
			...
			case IRI_REF:
				EnterOuterAlt(_localctx, 2);
				{
				State = 496; _localctx._iRIref = iRIref();
	...
	public ObjectListConstructContext objectListConstruct() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 503; _localctx.o0 = graphNodeConstruct();
			...
			while (_la==40) {
				...
				{
				State = 505; Match(40);
				State = 506; _localctx.o1 = graphNodeConstruct();
	...
	public GraphNodeConstructContext graphNodeConstruct() {
		...
		try {
			...
			case NIL:
				EnterOuterAlt(_localctx, 1);
				{
				State = 514; _localctx._varOrTermConstruct = varOrTermConstruct();
	...
	public VarOrTermConstructContext varOrTermConstruct() {
		...
		try {
			...
			case VAR2:
				EnterOuterAlt(_localctx, 1);
				{
				State = 520; _localctx._varLiteral = varLiteral();
			...
			case NIL:
				EnterOuterAlt(_localctx, 2);
				{
				State = 523; _localctx._graphTermConstuct = graphTermConstuct();
	...
	public partial class GraphTermConstuctContext : ParserRuleContext {
		...
		public ITerminalNode BlankNode() { return GetToken(sparql2PacParser.BlankNode, 0); }
		...
		public ITerminalNode NIL() { return GetToken(sparql2PacParser.NIL, 0); }
		public ITerminalNode BooleanLiteral() { return GetToken(sparql2PacParser.BooleanLiteral, 0); }
	...
	public GraphTermConstuctContext graphTermConstuct() {
		...
		try {
			...
			case String:
				EnterOuterAlt(_localctx, 2);
				{
				State = 531; _localctx._rDFLiteral = rDFLiteral();
			...
			case DOUBLE:
				EnterOuterAlt(_localctx, 3);
				{
				State = 534; _localctx._numeric = numeric();
			...
			case BooleanLiteral:
				...
				{
				State = 537; _localctx._BooleanLiteral = Match(BooleanLiteral);
			...
			case BlankNode:
				...
				{
				State = 539; _localctx._BlankNode = Match(BlankNode);
			...
			case NIL:
				...
				{
				State = 541; _localctx._NIL = Match(NIL);
	...
	public TriplesSameSubjectContext triplesSameSubject() {
		...
		try {
			...
			case NIL:
				EnterOuterAlt(_localctx, 1);
				{
				State = 545; varOrTermSub();
				State = 546; _localctx._propertyListNotEmpty = propertyListNotEmpty();
			...
			case 44:
				EnterOuterAlt(_localctx, 2);
				{
				State = 549; triplesNode();
				State = 550; propertyList();
	...
	public PropertyListNotEmptyContext propertyListNotEmpty() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 555; _localctx.main = verbObjectList();
			...
			while (_la==59) {
				...
				if (((((_la - 55)) & ~0x3f) == 0 && ((1L << (_la - 55)) & ((1L << (55 - 55)) | (1L << (PREFIXED_NAME - 55)) | (1L << (IRI_REF - 55)) | (1L << (VAR1 - 55)) | (1L << (VAR2 - 55)))) != 0)) {
					{
					State = 558; _localctx.seconds = verbObjectList();
	...
	public PropertyListContext propertyList() {
		...
		try {
			...
			if (((((_la - 55)) & ~0x3f) == 0 && ((1L << (_la - 55)) & ((1L << (55 - 55)) | (1L << (PREFIXED_NAME - 55)) | (1L << (IRI_REF - 55)) | (1L << (VAR1 - 55)) | (1L << (VAR2 - 55)))) != 0)) {
				{
				State = 568; propertyListNotEmpty();
	...
	public partial class VerbObjectListContext : ParserRuleContext {
		public Func<IEnumerable<RPackInt>, IEnumerable<RPackInt>> f;
		public Variable varOrIRIrefCtx;
	...
	public VerbObjectListContext verbObjectList() {
		...
		try {
			...
			{
			State = 573; verb();
			State = 574; _localctx._objectList = objectList();
	...
	public ObjectListContext objectList() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 577; _localctx.o0 = graphNode();
			...
			while (_la==40) {
				...
				{
				State = 579; Match(40);
				State = 580; _localctx.o1 = graphNode();
	...
	public VerbContext verb() {
		...
		try {
			...
			case VAR2:
				EnterOuterAlt(_localctx, 1);
				{
				State = 588; _localctx._varOrIRIref = varOrIRIref();
				 ((VerbObjectListContext)GetInvokingContext(43)).varOrIRIrefCtx = _localctx._varOrIRIref.p; 
				}
				break;
			case 55:
				EnterOuterAlt(_localctx, 2);
				...
				((VerbObjectListContext)GetInvokingContext(43)).varOrIRIrefCtx = varOrIRIrefCtx;	   
	...
	public TriplesNodeContext triplesNode() {
		...
		try {
			...
			case 4:
				EnterOuterAlt(_localctx, 2);
				{
				State = 598; blankNodePropertyList();
	...
	public BlankNodePropertyListContext blankNodePropertyList() {
		...
		try {
			...
			{
			State = 603; Match(4);
			State = 604; propertyListNotEmpty();
			State = 605; Match(37);
	...
	public GraphNodeContext graphNode() {
		...
		try {
			...
			case NIL:
				EnterOuterAlt(_localctx, 1);
				{
				State = 618; _localctx._varOrTerm = varOrTerm();
		...
		try {
			...
			case NIL:
				...
				State = 627; _localctx._graphTerm = graphTerm();
					((TriplesSameSubjectContext)GetInvokingContext(40)).subj.pacElement =  _localctx._graphTerm.entityCode; 
				}
				break;
			default:
				throw new NoViableAltException(this);
		...
		try {
			...
			case VAR2:
				...
				State = 632; _localctx._var = var();
					...
					var p = ((VerbObjectListContext)GetInvokingContext(43)).varOrIRIrefCtx;
					var sVar = ((TriplesSameSubjectContext)GetInvokingContext(40)).subj;		  	
						_localctx.f =  Query.CreateTriplet(sVar, p, _localctx._var.p, null);	 		
			...
			case NIL:
				EnterOuterAlt(_localctx, 2);
				{
				State = 635; _localctx._graphTerm = graphTerm();

					var p = ((VerbObjectListContext)GetInvokingContext(43)).varOrIRIrefCtx;
					var sVar = ((TriplesSameSubjectContext)GetInvokingContext(40)).subj;
					var o=new Variable(){ pacElement = _localctx._graphTerm.entityCode};
					...
					if(_localctx._graphTerm.d==null)
						...
						{oGraph=new GraphIsDataProperty(){IsData=true, vid=_localctx._graphTerm.d.vid};
						q.isDataGraph.Add(o.pacElement, oGraph);
						}
						 o.graph=oGraph;			
					_localctx.f =  Query.CreateTriplet(sVar, p, o, d:_localctx._graphTerm.d);
	...
	public VarOrIRIrefContext varOrIRIref() {
		...
		try {
			...
			case IRI_REF:
				EnterOuterAlt(_localctx, 2);
				{
				State = 643; _localctx._iRIref = iRIref();
					
				_localctx.p = new Variable(){
				    pacElement = TripleInt.Code(_localctx._iRIref.value)	 };
	...
	public VarContext var() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 648; _localctx._varLiteral = varLiteral();
	...
	public partial class VarLiteralContext : ParserRuleContext {
		public ITerminalNode VAR2() { return GetToken(sparql2PacParser.VAR2, 0); }
		public ITerminalNode VAR1() { return GetToken(sparql2PacParser.VAR1, 0); }
	...
	public GraphTermContext graphTerm() {
		...
		try {
			...
			case IRI_REF:
				EnterOuterAlt(_localctx, 1);
				{
				State = 653; _localctx._iRIref = iRIref();
				   _localctx.entityCode =  TripleInt.Code(_localctx._iRIref.value); 
				}
				break;
			case String:
				EnterOuterAlt(_localctx, 2);
				{
				State = 656; _localctx._rDFLiteral = rDFLiteral();
			...
			case DOUBLE:
				EnterOuterAlt(_localctx, 3);
				{
				State = 659; _localctx._numeric = numeric();
			...
			case BooleanLiteral:
				EnterOuterAlt(_localctx, 4);
				{
				State = 662; _localctx._BooleanLiteral = Match(BooleanLiteral);
			...
			case BlankNode:
				EnterOuterAlt(_localctx, 5);
				{
				State = 664; Match(BlankNode);
				 _localctx.entityCode =  TripleInt.Code("blank node"); 
				}
				break;
			case NIL:
				EnterOuterAlt(_localctx, 6);
	...
	public ExpressionContext expression() {
		...
		try {
			...
			State = 671; _localctx._conditionalAndExpression = conditionalAndExpression();
			...
			while (_la==64) {
				...
				State = 674; Match(64);
				State = 675; _localctx._conditionalAndExpression = conditionalAndExpression();
	...
	public ConditionalAndExpressionContext conditionalAndExpression() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 685; _localctx.main = valueLogical();
			...
			while (_la==63) {
				...
				{
				State = 687; Match(63);
				State = 688; _localctx.alt = valueLogical();
	...
	public ValueLogicalContext valueLogical() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 696; _localctx.main = additiveExpression();
			 _localctx.value = _localctx.main.value; _localctx.singleNewParameter = _localctx.main.singleNewParameter;
			State = 722;
			switch (_input.La(1)) {
			case 26:
			...
			case 65:
				{
				State = 710; Match(65);
				State = 711; _localctx.second = additiveExpression();
			...
			case 11:
				{
				State = 714; Match(11);
				State = 715; _localctx.second = additiveExpression();
			...
			case 70:
				{
				State = 718; Match(70);
				State = 719; _localctx.second = additiveExpression();
	...
	public partial class AdditiveExpressionContext : ParserRuleContext {
		...
		public ITerminalNode NumericLiteralNegative(int i) {
			return GetToken(sparql2PacParser.NumericLiteralNegative, i);
		}
		public MultiplicativeExpressionContext multiplicativeExpression(int i) {
			return GetRuleContext<MultiplicativeExpressionContext>(i);
		}
		public ITerminalNode NumericLiteralPositive(int i) {
			return GetToken(sparql2PacParser.NumericLiteralPositive, i);
		}
		public IReadOnlyList<MultiplicativeExpressionContext> multiplicativeExpression() {
			return GetRuleContexts<MultiplicativeExpressionContext>();
		}
		public IReadOnlyList<ITerminalNode> NumericLiteralPositive() { return GetTokens(sparql2PacParser.NumericLiteralPositive); }
		public IReadOnlyList<ITerminalNode> NumericLiteralNegative() { return GetTokens(sparql2PacParser.NumericLiteralNegative); }
	...
	public AdditiveExpressionContext additiveExpression() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 724; _localctx.main = multiplicativeExpression();
			 _localctx.value = _localctx.main.value; _localctx.singleNewParameter = _localctx.main.singleNewParameter; 
			State = 740;
			_errHandler.Sync(this);
			_la = _input.La(1);
			while (((((_la - 43)) & ~0x3f) == 0 && ((1L << (_la - 43)) & ((1L << (43 - 43)) | (1L << (58 - 43)) | (1L << (NumericLiteralPositive - 43)) | (1L << (NumericLiteralNegative - 43)))) != 0)) {
				...
				case 58:
					{
					State = 726; Match(58);
					State = 727; _localctx.second = multiplicativeExpression();
				...
				case 43:
					{
					State = 730; Match(43);
					State = 731; _localctx.second = multiplicativeExpression();
				...
				case NumericLiteralPositive:
					{
					State = 734; _localctx._NumericLiteralPositive = Match(NumericLiteralPositive);
				...
				case NumericLiteralNegative:
					{
					State = 736; _localctx._NumericLiteralNegative = Match(NumericLiteralNegative);
	...
	public MultiplicativeExpressionContext multiplicativeExpression() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 743; _localctx.main = unaryExpression();
			 _localctx.value = _localctx.main.value; _localctx.singleNewParameter = _localctx.main.singleNewParameter; 
			State = 755;
			_errHandler.Sync(this);
			_la = _input.La(1);
			while (_la==6 || _la==69) {
				...
				case 6:
					{
					State = 745; Match(6);
					State = 746; _localctx.second = unaryExpression();
				...
				case 69:
					{
					State = 749; Match(69);
					State = 750; _localctx.second = unaryExpression();
	...
	public UnaryExpressionContext unaryExpression() {
		...
		try {
			...
			case 35:
				...
				{
				State = 758; Match(35);
				State = 759; _localctx._primaryExpression = primaryExpression();
			...
			case 58:
				...
				{
				State = 762; Match(58);
				State = 763; _localctx._primaryExpression = primaryExpression();
			...
			case 43:
				...
				{
				State = 766; Match(43);
				State = 767; _localctx._primaryExpression = primaryExpression();
			...
			case DOUBLE:
				EnterOuterAlt(_localctx, 4);
				{
				State = 770; _localctx._primaryExpression = primaryExpression();
	...
	public PrimaryExpressionContext primaryExpression() {
		...
		try {
			...
			case 44:
				EnterOuterAlt(_localctx, 1);
				{
				State = 775; _localctx._brackettedExpression = brackettedExpression();
			...
			case 71:
				EnterOuterAlt(_localctx, 2);
				{
				State = 778; _localctx._builtInCall = builtInCall();
				 _localctx.value = _localctx._builtInCall.value;  
				}
				break;
			case PREFIXED_NAME:
			case IRI_REF:
				EnterOuterAlt(_localctx, 3);
				{
				State = 781; _localctx._iRIrefOrFunction = iRIrefOrFunction();
			...
			case String:
				EnterOuterAlt(_localctx, 4);
				{
				State = 784; _localctx._rDFLiteral = rDFLiteral();
			...
			case DOUBLE:
				EnterOuterAlt(_localctx, 5);
				{
				State = 787; _localctx._numeric = numeric();
			...
			case BooleanLiteral:
				EnterOuterAlt(_localctx, 6);
				{
				State = 790; _localctx._BooleanLiteral = Match(BooleanLiteral);
	...
	public BrackettedExpressionContext brackettedExpression() {
		...
		try {
			...
			{
			State = 797; Match(44);
			State = 798; _localctx._expression = expression();
			State = 799; Match(19);
	...
	public BuiltInCallContext builtInCall() {
		...
		try {
			...
			case 1:
				...
				Consume();
				State = 803; Match(44);
				State = 804; _localctx._expression = expression();
				State = 805; Match(19);
			...
			case 2:
				...
				Consume();
				State = 809; Match(44);
				State = 810; _localctx._rDFLiteral = rDFLiteral();
				State = 811; Match(19);
			...
			case 4:
				...
				Consume();
				State = 821; Match(44);
				State = 822; _localctx.l = expression();
				State = 823; Match(40);
				State = 824; Match(21);
				State = 825; Match(19);
			...
			case 5:
				...
				Consume();
				State = 829; Match(44);
				State = 830; _localctx.l = expression();
				State = 831; Match(40);
				State = 832; _localctx.r = expression();
				State = 833; Match(19);
			...
			case 8:
				...
				State = 848; Match(33);
				State = 849; Match(44);
				State = 850; _localctx.l = expression();
				State = 851; Match(40);
				State = 852; _localctx.r = expression();
				State = 853; Match(19);
			...
			case 13:
				...
				{
				State = 880; _localctx._regexExpression = regexExpression();
	...
	public partial class RegexExpressionContext : ParserRuleContext {
		...
		public IReadOnlyList<ITerminalNode> String() { return GetTokens(sparql2PacParser.String); }
		public ITerminalNode String(int i) {
			return GetToken(sparql2PacParser.String, i);
		}
		public VarContext var() {
			return GetRuleContext<VarContext>(0);
		}
	...
	public RegexExpressionContext regexExpression() {
		...
		try {
			...
			Consume();
			State = 886; Match(44);
			State = 887; _localctx.v = var();
			State = 888; Match(40);
			State = 889; _localctx.rex = Match(String);
			State = 892;
			_la = _input.La(1);
			if (_la==40) {
				{
				State = 890; Match(40);
				State = 891; _localctx.extraParam = Match(String);
				}
			}
	...
	public IRIrefOrFunctionContext iRIrefOrFunction() {
		...
		try {
			...
			_localctx.value =  Expression.Constant(TripleInt.Code(_localctx._iRIref.value));
			State = 902;
			_la = _input.La(1);
			if (_la==44 || _la==NIL) {
				{
				State = 899; _localctx._argList = argList();
				 _localctx.value =  Query.Call(_localctx._iRIref.value,  _localctx._argList.value);  
				}
			}
	...
	public partial class RDFLiteralContext : ParserRuleContext {
		...
		public Text literalText;
		public IToken _String;
		public IToken _LANGTAG;
		public IRIrefContext _iRIref;
		public ITerminalNode String() { return GetToken(sparql2PacParser.String, 0); }
		public IRIrefContext iRIref() {
			return GetRuleContext<IRIrefContext>(0);
		}
		public ITerminalNode LANGTAG() { return GetToken(sparql2PacParser.LANGTAG, 0); }
	...
	public RDFLiteralContext rDFLiteral() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 904; _localctx._String = Match(String);

			var s= (_localctx._String!=null?_localctx._String.Text:null);	 
			s = s.Substring(1,s.Length-2);
			_localctx.literalText =   new Text(){Value=s};
			_localctx.value = new Literal(LiteralVidEnumeration.text){Value=_localctx.literalText};	  

			State = 912;
			switch (_input.La(1)) {
			case LANGTAG:
				{
				State = 906; _localctx._LANGTAG = Match(LANGTAG);
				 _localctx.literalText.Lang = (_localctx._LANGTAG!=null?_localctx._LANGTAG.Text:null).ToLower(); 
				}
				break;
			case 14:
				{
				{
				State = 908; Match(14);
				State = 909; _localctx._iRIref = iRIref();
				 
				var type = _localctx._iRIref.value;		 
				DateTime tempDate;
				Double tempNum;
				bool tempBool;
				...
				if(!DateTime.TryParse(s, out tempDate)) throw new Exception("7");
					 _localctx.value = new Literal(LiteralVidEnumeration.date){Value = tempDate.ToBinary()};
				}
				else if(type =="http://www.w3.org/2001/XMLSchema#boolean")
				{
				if(!bool.TryParse(s, out tempBool)) throw new Exception("7");
					_localctx.value = new Literal(LiteralVidEnumeration.boolean){Value = tempBool };
				}
				...
				if(!double.TryParse(s, out tempNum) && !double.TryParse(s.Replace(".",","), out tempNum)) throw new Exception("7");
					_localctx.value = new Literal(LiteralVidEnumeration.integer){Value = tempNum };
				}
				else if(type =="http://www.w3.org/2001/XMLSchema#string") {  _localctx.literalText.Lang ="en"; }
				else _localctx.value =  new Literal(LiteralVidEnumeration.typedObject){ Value = new TypedObject{Value=_localctx.literalText.Value, Type=type} };
	...
	public partial class IRIrefContext : ParserRuleContext {
		...
		public ITerminalNode IRI_REF() { return GetToken(sparql2PacParser.IRI_REF, 0); }
		public ITerminalNode PREFIXED_NAME() { return GetToken(sparql2PacParser.PREFIXED_NAME, 0); }
		...
		try {
			...
			case IRI_REF:
				...
				State = 914; _localctx._IRI_REF = Match(IRI_REF);
						...
						var iri=(_localctx._IRI_REF!=null?_localctx._IRI_REF.Text:null);
						_localctx.value =  iri.Substring(1,iri.Length-2); 
				}
				break;
			case PREFIXED_NAME:
				EnterOuterAlt(_localctx, 2);
				...
				var match = PrefixNSSlpit.Match((_localctx._PREFIXED_NAME!=null?_localctx._PREFIXED_NAME.Text:null));		            
				 _localctx.value =  q.prefixes[match.Groups[1].Value] + match.Groups[2].Value; 
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public partial class NumericLiteralContext : ParserRuleContext {
		public ITerminalNode NumericLiteralPositive() { return GetToken(sparql2PacParser.NumericLiteralPositive, 0); }
		public NumericLiteralUnsignedContext numericLiteralUnsigned() {
			return GetRuleContext<NumericLiteralUnsignedContext>(0);
		}
		public ITerminalNode NumericLiteralNegative() { return GetToken(sparql2PacParser.NumericLiteralNegative, 0); }
	...
	public partial class NumericLiteralUnsignedContext : ParserRuleContext {
		public ITerminalNode DOUBLE() { return GetToken(sparql2PacParser.DOUBLE, 0); }
		public ITerminalNode INTEGER() { return GetToken(sparql2PacParser.INTEGER, 0); }
		public ITerminalNode DECIMAL() { return GetToken(sparql2PacParser.DECIMAL, 0); }
	...
	public static readonly string _serializedATN =
		...
		"\x98\n\x2\x3\x2\x3\x2\x3\x3\x5\x3\x9D\n\x3\x3\x3\a\x3\xA0\n\x3\f\x3\xE"+
		"\x3\xA3\v\x3\x3\x4\x3\x4\x3\x4\x3\x5\x3\x5\x3\x5\x3\x5\x3\x5\x3\x6\x3"+
		"\x6\x3\x6\x3\x6\x3\x6\x5\x6\xB2\n\x6\x3\x6\x3\x6\x3\x6\x6\x6\xB7\n\x6"+
		"\r\x6\xE\x6\xB8\x3\x6\x3\x6\x5\x6\xBD\n\x6\x3\x6\a\x6\xC0\n\x6\f\x6\xE"+
		"\x6\xC3\v\x6\x3\x6\x3\x6\x3\x6\x3\x6\x3\a\x3\a\x3\a\a\a\xCC\n\a\f\a\xE"+
		"\a\xCF\v\a\x3\a\x3\a\x3\a\x3\a\x3\b\x3\b\x3\b\x3\b\x3\b\x3\b\x3\b\